<template>
  <div class="job-info">
    <i class="el-icon-printer" style="float:right;font-size:20px;" @click="$router.push('/employees/print/' + userId)" />
    <!-- 基础信息 -->
...
import { getEmployeeJobInfo, saveEmployeeJobInfo } from '@/api/employees.js'
export default {
  data() {
    return {
