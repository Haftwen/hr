<template>
  <div class="dashboard-container">
    <!-- 打印 v-print注册了点击事件 给要打印的内容加id指定要打印的内容 -->
...
<script>
import { getEmployeeJobInfo as getJobDetail } from '@/api/employees'
import { getPersonalDetail, getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
